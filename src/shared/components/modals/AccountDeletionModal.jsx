...
const AccountDeletionModal = ({
  ...
  const { mutate: deleteAccount, isPending, error } = useScheduleAccountDeletion();
      ...
      <ModalContainer>
        ...
        <Form onSubmit={handleSubmit}>
          <ModalBody>
            ...
            {error && (
              <ErrorState 
                message={error?.message || "Failed to schedule deletion. Please try again."}
              />
            )}
          </ModalBody>
          ...
          <ModalFooter>
            ...
            <DeleteButton
              ...
              $loading={isPending}
            >
              {isPending ? <ButtonSpinner size="sm" /> : "Schedule Deletion"}
            </DeleteButton>
          </ModalFooter>
        </Form>
      </ModalContainer>
