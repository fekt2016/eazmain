...
export const ButtonSpinner = styled.div`
  ...
  border-color: var(--color-primary-400, rgba(255,255,255,0.3));
  border-top-color: var(--color-primary-500, #ffffff);
  border-radius: 50%;
...
export const LoadingButton = styled.button`
  position: relative;
  background: ${({ bg }) => bg || "var(--color-primary-500, #4CAF50)"};
  ...
  &:hover {
    background: ${({ hoverBg }) =>
      hoverBg || "var(--color-primary-600, #45a049)"};
