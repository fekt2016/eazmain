 ...
 * FIXED Saiisai HQ Location - This matches the backend warehouse location
 * 
...
// Fixed warehouse location - Saiisai HQ
// This must match the backend WAREHOUSE_LOCATION
export const WAREHOUSE_LOCATION = {
  lat: 5.582930, // Saiisai HQ latitude
  lng: -0.171870, // Saiisai HQ longitude
  address: 'HRH2+R22, Al-Waleed bin Talal Highway, Accra, Ghana',
};
